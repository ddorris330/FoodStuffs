...
<div class="w3-row-padding w3-padding-8 w3-center">
	<h1>Welcome <?php echo $_POST["name"]; ?>! <br> </h1> </div>
<hr style="border-color: grey; opacity: 0.5">

<div class="w3-row-padding w3-padding-8 w3-center"><h2>Popular Searches</h2></div> 
  <!-- First Photo Grid-->

<div class="w3-row-padding w3-padding-8 w3-center" id="r1">
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button"> <div class="w3-quarter"> 
    <img src="Images/Chicken.jpg" alt="Insert Link to Suggested Searches" style="width:83.5%">
    <h3>Chicken</h3>
    </a>
    </div>
    ...
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button"> <div class="w3-quarter">
      <img src="Images/Fish.jpg" alt="Fish" style="width:100%">
      <h3>Fish</h3>
      </a>
    </div>

    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button"> <div class="w3-quarter">
      <img src="Images/Vegetables.jpg" alt="Vegetables" style="width:79%">
      <h3>Vegetables</h3>
      </a>
    </div>
</div>
...
<div class="w3-row-padding w3-padding-16 w3-center" id="r2">
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button">
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/Breakfast.jpg" alt="Breakfast" style="width:106.5%">
      <h3>Breakfast</h3>
      </a>
    </div>
    ...
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button">
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/Lunch.jpg" alt="Lunch" style="width:100%">
      <h3>Lunch</h3>
      </a>
    </div>
    ...
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button">
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/Dinner.jpg" alt="Dinner" style="width:100%">
      <h3>Dinner</h3>
      </a>
    </div>
    ...
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button"> 
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/Dessert.jpg" alt="Dessert" style="width:86.5%">
      <h3>Dessert</h3>
      </a>
    </div>
</div>
...
<div class="w3-row-padding w3-padding-16 w3-center" id="r3">
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button">
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/American.jpg" alt="American" style="width:91%">
      <h3>American</h3>
      </a>
    </div>
    ...
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button">
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/Mexican.jpg" alt="Mexican" style="width:100%">
      <h3>Mexican</h3>
      </a>
    </div>
    ...
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button">
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/Asian.jpg" alt="Asian" style="width:90.5%">
      <h3>Asian</h3>
      </a>
    </div>
    ...
    <a href="search_results.html" onclick="w3_close()" class="w3-bar-item w3-button">
    <div class="w3-quarter w3-button w3-padding-16">
      <img src="Images/Italian.jpg" alt="Italian" style="width:100%">
      <h3>Italian</h3>
      </a>
    </div>
</div>
